    ...
    <div class="d-flex " id="wrapper">
            ...
            <div class="list-group  bg-danger " id="side">
                ...
                <div class="dropright">
                    ...
                    <div class="dropdown-menu bg-danger">
                        ...
                        <a class="dropdown-item bg-white" href="{{route('Notshow')}}"> <i class="fa fa-search"></i> Show Notifications</a>
                    </div>
                </div>

                <div class="dropright">
                    <a href="sidebar.html" class="nav-link dropdown-toggle list-group-item list-group-item-action" href="" data-toggle="dropdown"> <i class="fas fa-door-open"></i> Classes</a>
                    <div class="dropdown-menu bg-danger">
                        <li class="dropdown-header bg-primary font-weight-bold text-white">Classes Options</li>
                        <a class="dropdown-item bg-white" href="{{route('selectTeacher')}}"> <i class="fas fa-edit"> </i> Add New Class</a>
                        <a class="dropdown-item bg-white" href="{{route('updateClassshow')}}"> <i class="fa fa-trash"></i> Update Class</a>
                        <a class="dropdown-item bg-white" href="{{route('delClassshow')}}"> <i class="fas fa-pen-square"> </i> Delete Class</a>
                        <a class="dropdown-item bg-white" href="{{route('classShow')}}"> <i class="fa fa-search"></i> List Classes</a>
                    </div>
                </div>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark  border-bottom justify-content-lg-between ">
                ...
                <marquee width="40%" direction="left" height="50px" scrollamount="3" class=" justify-content-end ">
