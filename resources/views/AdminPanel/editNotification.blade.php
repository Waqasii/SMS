...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST"  action="{{route('updateNot',$not->id)}}" > 
                {{csrf_field()}}
                <div class="text-center">
                  <img src="{{URL::asset('/images/notification.png')}}" alt="profile Pic"  class="rounded-pill" height="100" width="200">
                    ...
                    <div class="form-group row mt-1">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $not->title }}" name='title' class="form-control"  >
                      </div>
                    </div> 
                    <div class="form-group row ">
                      <label  class="col-sm-2 col-form-label ">Description:</label>
                      <div class="col-sm-10">
                      <textarea class="form-control rounded-0"   name="description" rows="10">{{ $not->description }}</textarea>  
                    </div>
                    </div>
                    ...
                    <div class="form-group row ">
                      ...
                      <div class="col-sm-10">
                      <input type="date" name="end_date" value="{{ $not->end_date }}"/>
