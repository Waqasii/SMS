        ...
        <form method="POST"  action="{{route('updateClass',$class->id)}}" > 
                ...
                <div class="text-center">
                    ...
                    <div class="form-group row mt-4">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name='room_no' value="{{ $class->room_no }}" class="form-control"  placeholder="06">
                      </div>
                    </div>
                    ...
                    <div class="form-group row ">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="class_name" value="{{ $class->class_name }}" class="form-control"  placeholder="4th">
                      </div>
                    </div>
