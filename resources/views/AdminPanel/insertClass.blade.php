...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST"  action="{{route('classAdd',$id)}}" > 
                {{-- action="{{url('Login/')}}  you can use this type of linking of u don’t want to give name to your routes --}}
                {{csrf_field()}}

                {{-- RegisterTeacherB.jpeg --}}
                <div class="text-center">
                    <img src="{{URL::asset('/images/class.jpeg')}}" alt="profile Pic"  class="rounded-pill" height="100" width="200">

                </div>
                    <div class="form-group row mt-4">
                      <label  class="col-sm-2 col-form-label ">Room No:</label>
                      <div class="col-sm-10">
                        <input type="text" name='room_no' class="form-control"  placeholder="06">
                      </div>
                    </div>
                    ...
                    <div class="form-group row ">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="class_name" class="form-control"  placeholder="4th">
                      </div>
                    </div>
