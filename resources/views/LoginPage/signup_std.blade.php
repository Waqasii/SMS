...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-container container" style="margin-top: 1%;">
        ...
        <form method="POST"  action="{{route('stdReg')}}" > 
                ...
                {{csrf_field()}}
                    ...
                    <div class="text-center">
                        <img src="{{URL::asset('/images/RegisterStudentW.jpeg')}}" alt="profile Pic"  class="rounded-pill" height="100" width="200">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10 ">
                            ...
                            <a href="{{ URL::previous() }}"><button type="submit" class="btn btn-primary">Register</button></a>
